...
@section('title') Event Photos @endsection

@section('meta_tags')
	<meta name="title" content="Event Photos">
    <meta name="keywords" content="Event Photos">
    <meta name="description" content="Event Photos">
@endsection
           ...
           <div class="row justify-content-center">
              <div class="col-xl-8">
                 <div class="tp-event-title-box text-center">
                    <h4 class="tp-section-title">Event Photos</h4>
                 </div>
              </div>
           </div>
        </div>
        <div class="row">
		      @if($latest_event_photos)
                @foreach ($latest_event_photos as $item)
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div class="tp-event-item text-center">
                        <div class="tp-event-thumb fix">
                            <img src="{{ static_asset($item->image) }}" alt="Event Photos">
                        </div>
