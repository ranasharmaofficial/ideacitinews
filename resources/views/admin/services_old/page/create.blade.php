...
@section('title', 'Add New Service Page')
@section('content')
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-2">
                        <h4 class="card-title float-left mt-2">Add New Service Page</h4>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row formtype">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="slug" placeholder="service_name_without_space"> 
                                    </div>
                                </div>
