    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-2">
						<a style="float:right;" class="btn btn-warning" href="{{ route('admin.solutions.index') }}">Solution List</a>
                        <h4 class="card-title float-left mt-2">Update Solution</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body booking_card">
                        <form method="post" action="{{ route('admin.solutions.update',$page->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row formtype">
								...
								<div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="page_url" value="{{ $page->page_url }}" required>
                                    </div>
                                </div>
