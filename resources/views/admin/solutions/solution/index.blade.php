    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <a class="btn btn-primary float-right" href="{{ url('admin/solutions/create') }}">Add New Solution</a>
                    <div class="breadcrumb mt-3 border-bottom pb-2">
                        <a href="{{ url('') }}"><i class="fa fa-home" aria-hidden="true"></i> Home</a>/Solution
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card card-table">
                    <div class="card-body booking_card">
                        ...
                        <form method="GET" class="form">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title float-left mt-2">Solution List</h4>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
												<a class="text-primary" href="{{ route('admin.solutions.edit',$value->id) }}"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
												&nbsp;&nbsp;<a class="text-danger" onclick="return confirm('Are you sure, you want to delete this?')" href="{{route('admin.solutions.delete',$value->id)}}"><i class="fas fa-trash-alt m-r-5"></i>Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
