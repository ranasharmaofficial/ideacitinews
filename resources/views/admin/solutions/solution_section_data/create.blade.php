...
@section('title', 'Add Solution Section Data')
@section('content')
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-2">
                        <h4 class="card-title float-left mt-2">Add Solution Section Data</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body booking_card">
                        <form method="post" action="{{ route('admin.solution_section_data.store') }}" enctype="multipart/form-data">
                            @csrf
