...
@section('title', 'Update Solution Section Data')
@section('content')
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-2">
                        <h4 class="card-title float-left mt-2">Update Solution Section Data</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body booking_card">
                        <form method="post" action="{{ route('admin.solution_section_data.update',$section_data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row formtype">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if($section_data   ->img)
                                            <img src="{{asset('public/'.$section_data->img)}}" height="100" width="100">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
								 ...
								 <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if($section_data->other)
                                            <img src="{{asset('public/'.$section_data->other)}}" height="100" width="100">
                                        @endif
                                    </div>
                                </div>
