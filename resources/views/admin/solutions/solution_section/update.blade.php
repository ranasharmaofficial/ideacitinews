...
@section('title', 'Update Solution Section')
@section('content')
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-2">
                        <h4 class="card-title float-left mt-2">Update Solution Section</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body booking_card">
                        <form method="post" action="{{ route('admin.solution_page_sections.update',$page_section->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row formtype">
                               ...
                               <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Title </label>
                                        <input class="form-control" name="title" value="{{$page_section->title}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if($page_section->image)
                                            <img src="{{asset('public/'.$page_section->image)}}" height="100" width="100">
                                        @endif
                                    </div>
                                </div>
