        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <a class="btn btn-primary float-right" href="{{ url('admin/section_data/create') }}">Add New Section Data</a>
                            ...
                            <form method="GET" class="form">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <a href="{{ url('admin/section_data') }}" class="btn btn-warning"> Reset </a>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a class="text-primary" href="{{ route('admin.section_data.edit',$value->id) }}"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
												&nbsp;&nbsp;<a class="text-danger" onclick="return confirm('Are you sure, you want to delete this?')" href="{{route('admin.cmssection_data.delete',$value->id)}}"><i class="fas fa-trash-alt m-r-5"></i>Delete</a>
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
