        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="row row-sm">
                    <div onclick="window.location.href='{{ url('admin/image_categories') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="project-content">
                                        ...
                                        <ul>
                                            <li>
                                                <strong>Image</strong>
                                                <span>{{ $data['image_category_count'] }}</span>
                                            </li>
                    ...
                    <div onclick="window.location.href='{{ url('admin/galleries') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card  overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
                    ...
                    <div onclick="window.location.href='{{ url('admin/customer/leads') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
                    ...
                    <div onclick="window.location.href='{{ url('admin/online/enquiry') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
                                    ...
                                    <div class="project-content">
                                        ...
                                        <ul>
                                            <li>
                                                <strong>Total</strong>
                                                <span>{{$data['product_enquiry_count']}}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
					...
					<div onclick="window.location.href='{{ url('admin/career/enquiry') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
                                    ...
                                    <div class="project-content">
                                        <h6>Career Enquiry</h6>
                                        <ul>
                                            <li>
                                                <strong>Total</strong>
                                                <span>{{ $data['job_enquiry_count'] }}</span>
                                            </li>
                    ...
                    <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                        <div class="card overflow-hidden">
                            <div class="card-header bg-transparent p-4">
                                ...
                                <p class="fs-12 text-muted mb-2">The Project Budget is a tool used by project managers to estimate the total cost of a project. <a class="text-primary" href="">Learn more</a></p>
                            </div>
                            <div class="card-body pd-y-7">
                                <div class="area chart-legend mb-0 d-flex justify-content-center">
                                    <div class="ms-2">
                                        <i class="mdi mdi-album text-primary"></i> Total Budget
                                    </div>
                                    <div class="ms-2">
                                        <i class="mdi mdi-album text-pink"></i>Amount Used
                                    </div>
                                </div>
                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body pb-3">
                                <div class="card-header">
                                    ...
                                    <p class="fs-12 text-muted mb-3">In project, a task is an activity that needs to be accomplished within a defined period of time or by a deadline. <a class="text-primary" href="">Learn more</a></p>
                                </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-names">
                                                        ...
                                                        <p class="d-inline-block font-weight-semibold mb-0 fs-14">UI Design</p>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-names">
                                                        ...
                                                        <p class="d-inline-block font-weight-semibold mb-0 fs-14">Landing Page</p>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-names">
                                                        ...
                                                        <p class="d-inline-block font-weight-semibold mb-0 fs-14">Website &amp; Blog</p>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-names">
                                                        ...
                                                        <p class="d-inline-block font-weight-semibold mb-0 fs-14">Product Development</p>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-names">
                                                        ...
                                                        <p class="d-inline-block font-weight-semibold mb-0 fs-14">Logo Design</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="badge bg-success">Completed</div>
                ...
                <div class="row row-sm">
                        ...
                        <div class="card overflow-hidden latest-tasks">
                            ...
                            <div class="card-body pt-3">
                                <div class="tab-content">
                                    <div class="tab-pane fade border-0 p-0 active show" id="tasktab-1" role="tabpanel">
                                        <div class="">
                                            <div class="tasks">
                                                ...
                                                <div class="checkbox">
                                                    <div class="check-box">
                                                        <div class="ckbox"><input class="form-check-input" type="checkbox" value=""  checked></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tasks">
                                                ...
                                                <div class="checkbox">
                                                    <div class="check-box">
                                                        <div class="ckbox"><input class="form-check-input" type="checkbox" value=""></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tasks">
                                                ...
                                                <div class="checkbox">
                                                    <div class="check-box">
                                                        <label class="ckbox"><input class="form-check-input" type="checkbox" value=""></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tasks">
                                    ...
                                    <div class="tab-pane fade border-0 p-0" id="tasktab-2" role="tabpanel">
                                        <div class="">
                                            <div class="tasks">
                                                <div class=" task-line teal">
                                                    <a   href="javascript:void(0);" class="label">
                                    ...
                                    <div class="tab-pane fade border-0 p-0" id="tasktab-3" role="tabpanel">
                                        <div class="">
                                            <div class="tasks">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-4">
                        <div class="card overflow-hidden">
                            <div class="card-header pb-0">
                                ...
                                <p class="fs-12 text-muted mb-0"> In the Project Workload report, their remaining assignments, completion dates, whether their work is at-risk. <a class="text-primary" href="">Learn more</a></p>
                            </div>
                            <div class="card-body">
                                <div class="">
                                ...
                                <div class="pt-3 px-3">
                                    <div class="row ">
                                        <div class="col-sm-8 col-lg-7 col-xl-6">
                                            <h5 class="mb-0 fs-15 d-flex"><span class="legend bg-primary-gradient brround"></span>40.32%</h5>
                                            <p class="text-muted  fs-13 mb-0">External</p>
                                        </div>
                                        <div class="col-sm-4 col-lg-5 col-xl-6">
                                            <div id="externalchart" class="float-end"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="pt-3 px-3">
                                    <div class="row ">
                                        <div class="col-sm-8 col-lg-7 col-xl-6">
                                            <h6 class="mb-0 fs-15 d-flex"><span class="legend bg-danger-gradient brround"></span>40.73%</h6>
                                            <p class="text-muted fs-13 mb-0 ">Internal</p>
                                        </div>
                                        <div class="col-sm-4 col-lg-5 col-xl-6">
                                            <div id="internalchart" class="float-end"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="pt-3 px-3">
                                    <div class="row ">
                                        <div class="col-sm-8 col-lg-7 col-xl-6">
                                            <h6 class="mb-0 fs-15 d-flex"><span class="legend bg-success-gradient brround"></span>50.12%</h6>
                                            <p class="text-muted fs-13 mb-0">Other</p>
                                        </div>
                                        <div class="col-sm-4 col-lg-5 col-xl-6">
                                            <div id="otherchart" class="float-end"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
                        <div class="card card-dashboard-events">
                            <div class="card-header">
                                <h4 class="card-title mg-b-10 mt-2">Upcoming Events</h4>
                                <p class="fs-12 text-muted mb-0">It had the latest news and notes from the championship, while previewing the upcoming event.. <a class="text-primary" href="">Learn more</a></p>
                            </div>
                            <div class="card-body p-0">
                                <div class="list-group ">
                                    <div class="list-group-item border-top-0">
                                        ...
                                        <p><strong>8AM - 4PM</strong> Bay Area, San Francisco</p><small><span class="text-danger">Sold Out</span> (3000 tickets sold)</small>
                                    </div>
                                    <div class="list-group-item">
                                        ...
                                        <p><strong>8AM - 5PM</strong> Singapore</p><small><span class="text-warning">Sold Out Soon</span> (12 tickets left)</small>
                                    </div>
                                    <div class="list-group-item border-bottom-0">
                                        ...
                                        <p><strong>8AM - 5PM</strong> Singapore</p><small><span class="text-success">Free Registration</span> (Limited seats only)</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="card overflow-hidden review-project">
                            <div class="card-body">
                                ...
                                <p class="fs-12 text-muted mb-3">A project is an activity to meet the creation of a unique product or service and thus activities that are undertaken to accomplish routine activities cannot be considered projects. <a class="text-primary" href="">Learn more</a></p>
                                    ...
                                    <table class="table table-hover table-bordered mb-0 text-md-nowrap text-lg-nowrap text-xl-nowrap table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="project-contain">
                                                        <h6 class="mb-1 fs-13">Angular Project</h6>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="avatar-list-stacked image-grouped wd-100">
                                                        <span class="avatar avatar-rounded profile-img">
                                                            <img src="{{ static_asset('assets/assets_admin/images/faces/11.jpg') }}" alt="img">
                                                        </span>
                                                        <span class="avatar avatar-rounded profile-img">
                                                            <img src="{{ static_asset('assets/assets_admin/images/faces/12.jpg') }}" alt="img">
                                                        </span>
                                                        <span class="avatar avatar-rounded profile-img">
                                                            <img src="{{ static_asset('assets/assets_admin/images/faces/2.jpg') }}" alt="img">
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>Web Design</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-contain">
                                                        <h6 class="mb-1 fs-13">PHP Project</h6>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="avatar-list-stacked image-grouped wd-100">
                                                        <span class="avatar avatar-rounded profile-img">
                                                            <img src="{{ static_asset('assets/assets_admin/images/faces/16.jpg') }}" alt="img">
                                                        </span>
                                                        <span class="avatar avatar-rounded profile-img">
                                                            <img src="{{ static_asset('assets/assets_admin/images/faces/8.jpg') }}" alt="img">
                                                        </span>
                                                        <span class="avatar avatar-rounded profile-img">
                                                            <img src="{{ static_asset('assets/assets_admin/images/faces/7.jpg') }}" alt="img">
                                                        </span>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-contain">
                                                        <h6 class="mb-1 fs-13">Python</h6>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="avatar-list-stacked image-grouped wd-100">
                                                        <span class="avatar avatar-rounded profile-img">
                                                            <img src="{{ static_asset('assets/assets_admin/images/faces/3.jpg') }}" alt="img">
                                                        </span>
                                                        <span class="avatar avatar-rounded profile-img">
                                                            <img src="{{ static_asset('assets/assets_admin/images/faces/12.jpg') }}" alt="img">
                                                        </span>
                                                        <span class="avatar avatar-rounded profile-img">
                                                            <img src="{{ static_asset('assets/assets_admin/images/faces/15.jpg') }}" alt="img">
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>Web Development</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-contain">
                                                        <h6 class="mb-1 fs-13">Android App</h6>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="avatar-list-stacked image-grouped wd-100">
                                                        ...
                                                        <span class="avatar avatar-rounded profile-img">
                                                            <img src="{{ static_asset('assets/assets_admin/images/faces/6.jpg') }}" alt="img">
                                                        </span>
                                                        <span class="avatar avatar-rounded profile-img">
                                                            <img src="{{ static_asset('assets/assets_admin/images/faces/16.jpg') }}" alt="img">
                                                        </span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-contain">
                                                        <h6 class="mb-1 fs-13">Mobile Application</h6>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="avatar-list-stacked image-grouped wd-100">
                    ...
                    <div class="col-lg-12 col-xl-4 col-sm-12">
                        <div class="card">
                            <div class="card-header pb-0 pt-4">
                                ...
                                <p class="fs-12 text-muted mb-0">Project Description is a formally written declaration of the project and its idea and context . <a class="text-primary" href="">Learn more</a></p>
                            </div>
                            <div class="card-body p-0 m-scroll mh-350 mt-2">
                                <div class="list-group projects-list">
                                    <a   href="javascript:void(0);" class="list-group-item list-group-item-action flex-column align-items-start border-0 border-bottom">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="card overflow-hidden ">
                            <div class="card-header pb-0 pt-4">
                                ...
                                <p class="fs-12 text-muted mb-0">An activity is a scheduled phase in a project plan with a distinct beginning and end. <a class="text-primary" href="">Learn more</a></p>
                            </div>
                            <div class="">
                                <div class="card-body activity activity-scroll">
                                    <div class="activity-list">
                                        <img src="{{ static_asset('assets/assets_admin/images/faces/6.jpg') }}" alt="" class="img-activity">
                                        <div class="time-activity ">
                                            <div class="item-activity">
                                            <p class="mb-0"><span class="h6 me-1">Adam Berry</span><span class="text-muted fs-13"> Add a new projects</span> <span class="h6 ms-1 added-project"> AngularJS Template</span></p><small class="text-muted ">30 mins ago</small> </div>
                                        </div>
                                    <img src="{{ static_asset('assets/assets_admin/images/faces/9.jpg') }}" alt="" class="img-activity">
                                        <div class="time-activity">
                                            <div class="item-activity">
                                            <p class="mb-0"><span class="h6 me-1">Irene Hunter</span> <span class="text-muted fs-13"> Add a new projects</span> <span class="h6 ms-1 added-project text-danger">Free HTML Template</span></p><small class="text-muted ">1 days ago</small> </div>
                                        </div> <img src="{{ static_asset('assets/assets_admin/images/faces/3.jpg') }}" alt="" class="img-activity">
                                        <div class="time-activity">
                                            <div class="item-activity">
                                            <p class="mb-0"><span class="h6 me-1">John Payne</span> <span class="text-muted fs-13"> Add a new projects</span> <span class="h6 ms-1 added-project text-success">Free PSD Template</span></p><small class="text-muted ">3 days ago</small> </div>
                                        </div> <img src="{{ static_asset('assets/assets_admin/images/faces/4.jpg') }}" alt="" class="img-activity">
                                        <div class="time-activity">
                                            <div class="item-activity ">
                                            <p class="mb-0"><span class="h6 me-1">Julia Hardacre</span> <span class="text-muted fs-13"> Add a new projects</span> <span class="h6 ms-1 added-project text-warning">Free UI Template</span></p><small class="text-muted ">5 days ago</small> </div>
                                        </div> <img src="{{ static_asset('assets/assets_admin/images/faces/5.jpg') }}" alt="" class="img-activity">
                                        <div class="time-activity">
                                            <div class="item-activity">
                                            <p class="mb-0"><span class="h6 me-1">Adam Berry</span> <span class="text-muted fs-13"> Add a new projects</span> <span class="h6 ms-1 added-project text-pink"> AngularJS Template</span></p><small class="text-muted ">30 mins ago</small> </div>
                                        </div> <img src="{{ static_asset('assets/assets_admin/images/faces/6.jpg') }}" alt="" class="img-activity">
                                        <div class="time-activity">
                                            <div class="item-activity">
                                            <p class="mb-0"><span class="h6 me-1">Irene Hunter</span> <span class="text-muted fs-13"> Add a new projects</span> <span class="h6 ms-1 added-project text-purple">Free HTML Template</span></p><small class="text-muted ">1 days ago</small> </div>
                                        </div> <img src="{{ static_asset('assets/assets_admin/images/faces/16.jpg') }}" alt="" class="img-activity">
                                        <div class="time-activity">
                                            <div class="item-activity">
                                            <p class="mb-0"><span class="h6 me-1">John Payne</span><span class="text-muted fs-13"> Add a new projects</span> <span class="h6 ms-1 added-project text-success">Free PSD Template</span></p><small class="text-muted ">3 days ago</small> </div>
                                        </div> <img src="{{ static_asset('assets/assets_admin/images/faces/10.jpg') }}" alt="" class="img-activity">
                                        <div class="time-activity mb-0">
                                            <div class="item-activity mb-0">
                                            <p class="mb-0"><span class="h6 me-1">Julia Hardacre</span><span class="text-muted fs-13"> Add a new projects</span><span class="h6 ms-1 added-project">Free UI Template</span></p><small class="text-muted ">5 days ago</small> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="card">
                            <div class="card-header pt-4 pb-0">
                                ...
                                <p class="fs-12 text-muted mb-0">The Statistics You can also summarize your data in a graphical display, such as histograms <a class="text-primary" href="">Learn more</a> </p>
                            </div>
                            <div class="p-4">
                                <div class="">
                                    <div class="row">
                                        <div class="col-md-6 col-6 text-center">
                                            <div class="task-box primary mb-0">
                                                <p class="mb-0 fs-12">Total Tasks</p>
                                                <h3 class="mb-0 text-fixed-white">385</h3>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-6 text-center">
                                            <div class="task-box danger  mb-0">
                                                <p class="mb-0 fs-12">Overdue Tasks</p>
                                                <h3 class="mb-0 text-fixed-white">19</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="task-stat pb-0">
                                <div class="d-flex tasks">
                                    <div class="mb-0">
                                        ...
                                        <span class="text-muted fs-11 ms-4">8:00am - 10:30am</span>
                                    </div>
