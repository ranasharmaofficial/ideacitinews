                    ...
                    <div class="card custom-card">
                        <div class="card-header">
                            ...
                            <a style="right: 5px;position: absolute;float: right;" href="{{ url('admin/news/create') }}"
                                class="btn btn-danger-light btn-wave btn-sm float-right">Add News</a>
                        </div>
                        <div class="card-body booking_card">
                            <div class="table-responsive">
                                <table class="table table-stripped table-hover table-center mb-0 table table-bordered text-nowrap" id="responsiveDataTable" style="width:fit">
                                    <thead>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        data.forEach((data, index) => {
                            ...
                            if (data.status == 1) {
                                status = '<a href = "#" class = "btn btn-sm bg-success-light mr-2" > Active </a>'
                                
                            } else {
                                status = '<a href = "#" class = "btn btn-sm bg-danger-light mr-2" > Inactive </a>'
                            }
