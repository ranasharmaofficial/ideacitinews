			...
			<div class="ms-sm-1 ms-0">
				<nav>
					<ol class="breadcrumb mb-0">
						...
						<li class="breadcrumb-item active fw-normal" aria-current="page">Advertisement List</li>
					</ol>
				</nav>
			</div>
		</div>
                            ...
                            <div class="row formtype">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Select Place <span class="text-danger">*</span> </label>
                                        <select type="text" class="form-control" id="place" name="place" required>
                                            <option value="header">Header 730 X 90</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
