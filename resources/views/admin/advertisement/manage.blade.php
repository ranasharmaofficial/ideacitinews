                    ...
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title d-flex">
                                <span>Advertisements</span> (<p id="counting">0</p>)
                            </div>
                            <a style="right: 5px;position: absolute;float: right;"
                                href="{{ url('admin/advertisements/create') }}"
                                class="btn btn-danger-light btn-wave btn-sm float-right">Add New Advertisement</a>
                        </div>
