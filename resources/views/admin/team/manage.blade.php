                    ...
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title d-flex">
                                <span>Teams</span> (<p id="counting">0</p>)
                            </div>
                            <a style="right: 5px;position: absolute;float: right;"
                                href="{{ url('admin/teams/create') }}"
                                class="btn btn-danger-light btn-wave btn-sm float-right">Add New Team</a>
                        </div>
                        ...
                        data.forEach((data, index) => {
                            table.append(`
                                <tr class="mt-5">
                                    ...
                                    <td class="border-b border-gray-200 px-3 text-center py-2 text-sm"><img src="{{ static_asset('assets/assets_admin/images/team/${data.profile_pic}') }}" alt="" height="90px" weidth="100px"></td>
                                    <td class="border-b border-gray-200 px-3 text-center py-2 text-sm">${data.first_name}</td>
                                    <td class="border-b border-gray-200 px-3 text-center py-2 text-sm">${data.status}</td>
                                    <td class="border-b border-gray-200 px-3 text-center py-2 text-sm">${data.updated_by}</td>
                                    <td class="text-right">
                                        <div class="hstack gap-2 fs-15">
