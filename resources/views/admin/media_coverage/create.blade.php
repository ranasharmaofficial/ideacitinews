...
@section('title', 'Add New Media Coverage')
@section('content')
<!-- Page Header -->
			...
			<div class="ms-sm-1 ms-0">
				<nav>
					<ol class="breadcrumb mb-0">
						...
						<li class="breadcrumb-item active fw-normal" aria-current="page">Add New Media Coverage</li>
					</ol>
				</nav>
			</div>
		</div>
            ...
            <div class="col-sm-12">
                <div class="card custom-card">
					<div class="card-header">
						...
						<a style="right: 5px;position: absolute;float: right;" href="{{ url('admin/media-coverage') }}" class="btn btn-danger-light btn-wave btn-sm float-right">Media Coverage List</a>
					</div>
                    <div class="card-body booking_card">
                        <form method="post" action="{{ route('admin.mediaCoverageStore') }}" enctype="multipart/form-data">
                            @csrf
