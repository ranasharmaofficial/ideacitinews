...
@section('title', 'Update Service Section')
@section('content')
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-2">
                        <h4 class="card-title float-left mt-2">Update Service Section</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body booking_card">
                        <form method="post" action="{{ route('admin.service_sections.update',$page_section->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row formtype">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Title </label>
                                        <input class="form-control" value="{{$page_section->title}}" name="title" />
                                    </div>
                                </div>
