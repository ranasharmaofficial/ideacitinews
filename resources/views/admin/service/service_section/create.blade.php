    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-2">
                        <h4 class="card-title float-left mt-2">Add New Service Section</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body booking_card">
                        <form method="post" action="{{ route('admin.service_sections.store') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="section_name">
                                            ...
                                            {{--<option value="solution_section">Solution Built Section</option>
                                            <option value="pricing_section">Pricing Section</option>--}}
                                            <option value="key_points_section">Key Point Section (Black Background)</option>
