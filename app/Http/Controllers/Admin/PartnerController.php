...
class PartnerController extends Controller
{
    ...
    public function delete($id){
        $this->partnerRepository->deletePartner($id);
        return redirect()->route('admin.partner.index')->with(session()->flash('alert-danger', 'Data Deleted Successfully'));
    }
    ...
    /** Page Section CRUD Start */
        ...
        public function deletePartnerSection($id){
            $this->partnerRepository->deletePartnerSection($id);
            return redirect()->route('admin.partner_sections.index')->with(session()->flash('alert-danger', 'Deleted Successfully'));
        }
    ...
    /** Section Data CRUD End */
        ...
        public function deletePartnerSectionData($id){
            $this->partnerRepository->deletePartnerSectionData($id);
            return redirect()->route('admin.partnersection_data.index')->with(session()->flash('alert-danger', 'Data Deleted Successfully'));
        }
